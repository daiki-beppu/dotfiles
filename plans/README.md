...
| [013](013-readme-refresh.md) | README の構成図・管理表・セットアップ手順を実体に整合 | P2 | S | 007, (012) | DONE（executor worktree の branch `docs/readme-refresh`、commit `3df1a66`。レビュー済み・全 done criteria pass。012 未実施のため check.sh 行は規定どおり省略。マージ・push は未実施） |
