...
| [017](017-skill-workflow-contract-check.md) | skill ↔ workflow の契約整合チェックを CI 化 | P3 | M | 011, 012, (015) | DONE（`24c4240` で main にマージ済み。`bash scripts/check.sh contracts` exit 0。allowlist は takt 更新により stale — 次回 takt バージョンアップ時に再生成） |
