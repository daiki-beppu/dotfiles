...
| [002](002-multi-host-flake.md) | flake をマルチホスト化しハードコード排除 | P1 | M | 001 | DONE（`26bddd5` 時点に refresh 後実行。worktree `agent-a42c27c07105bf9af` の branch `fix/multi-host-flake`、commit `77d14f5`。レビュー済み・全 done criteria pass。マージは未実施） |
...
| [005](005-public-repo-cleanup.md) | 公開リポジトリから事故コミットを除去 | P2 | S | 003 | TODO |
