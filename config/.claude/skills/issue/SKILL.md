...
要件が8件以上、影響ファイルが10件以上、または独立した機能領域が複数混在する場合は、sub-issue 分割案を提示してユーザーと合意する。分割で合意した場合は親 issue を本スキルで作成し、子 issue の作成と GraphQL `addSubIssue` での親子接続は issue-organize スキルの手順に従う。
